    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Chrysanthemum", image: "https://cdn.pixabay.com/photo/2018/09/23/14/24/chrysanthemum-3698197_1280.jpg", description: "Natural insect repellent with beautiful blooms.", cost: "$16" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Valerian", image: "https://cdn.pixabay.com/photo/2019/09/16/07/41/balm-4480134_1280.jpg", description: "Promotes relaxation and improves sleep quality.", cost: "$17" },
                { name: "Feverfew", image: "https://cdn.pixabay.com/photo/2016/08/19/19/48/flowers-1606041_1280.jpg", description: "Used to prevent migraines and reduce inflammation.", cost: "$14" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Devil's Ivy", image: "https://cdn.pixabay.com/photo/2018/11/15/10/32/plants-3816945_1280.jpg", description: "Nearly indestructible plant that thrives in any condition.", cost: "$12" }
            ]
        }
    ];
